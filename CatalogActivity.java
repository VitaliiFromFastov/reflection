...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            //get indices of all columns in pet table
            ...
            while (cursor.moveToNext()){
                // using indices we get values from the table pets
                int _idValue = cursor.getInt(idIndex);
                String nameValue = cursor.getString(nameIndex);
                String breedValue = cursor.getString(breedIndex);
                int genderValue = cursor.getInt(genderIndex);
                int weightValue = cursor.getInt(weightIndex);
